...
use CompanyOS\Bundle\CoreBundle\Application\Plugin\Command\ActivatePluginCommand;
...
#[AsMessageHandler]
class ActivatePluginCommandHandler implements CommandHandlerInterface
{
    ...
    public function __invoke(ActivatePluginCommand $command): void
    {
